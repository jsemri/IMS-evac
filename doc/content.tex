...
Results are displayed in Figure~\ref{fig-d} and Figure~\ref{fig-e}.
...
the reason for this is that, in both D3 and D4 cases, large queues had had
created at the narrow exits from the lecture room
(see Figure~\ref{fig:fig-d4}), which is the main source of delay.
In D5 one of this entrances is blocked and the effect here is even more
apparent, see Figure~\ref{fig:fig-d5}.
...
cellular automata.
We designed a diverse experiment suite representing different fire scenarios.
